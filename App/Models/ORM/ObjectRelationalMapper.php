 ...
 * @method array<int,self> find(int $id) Retrieving a single record from the database table based on the given ID.
 * @method self create(array $data) Creating a new record in the database table.
...
abstract class Object_Relational_Mapper
{
     ...
     * @return array<int,self> The record retrieved from the database table.
     * @abstract
     */
     ...
     * @return self The ID of the newly created record.
     * @abstract
     */
